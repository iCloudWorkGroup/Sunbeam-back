...
public interface MColDao {
	 ...
	 * @param status
	 */
	void updateColHiddenStatus(String excelId,String sheetId,String alias,boolean status);
	 ...
	 * @param width
	 */
	void updateColWidth(String excelId,String sheetId,String alias,Integer width);
